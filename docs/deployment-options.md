...
- A stable ChatGPT web and Claude.ai connector endpoint at `https://your-domain.example/sse`.
- A stable Codex / HTTP MCP endpoint at `https://your-domain.example/mcp`.
